        ...
        const eventDescription2 = document.getElementById('event-description2');
        const closeEventBtn = document.getElementById('close-event');
        // Attach event listeners to buttons
        document.querySelectorAll('.game-card').forEach(card => {
            const title = card.querySelector('h3').innerText;
            const description = card.querySelector('p').innerText;
            const description2 = card.querySelector('.main-p').innerText;
        ...
        const mainRules = document.getElementById('main-rules');
            ...
            card.querySelector('.pixel-button-preview').addEventListener('click', (e) => {
                ...
                eventDescription.innerText = mainRules;
                eventDescription2.innerText = description2;
